...
},{"process":"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../../../node_modules/crypto-js/core.js":[function(require,module,exports) {
var define;
...
function createGravatarUrl(username) {
  ...
  return "http://www.gravatar.com/avatar/".concat(userhash.toString());
}
...
},{"jquery":"../../../node_modules/jquery/dist/jquery.js","crypto-js/md5":"../../../node_modules/crypto-js/md5.js"}],"storage.js":[function(require,module,exports) {
"use strict";
...
function (_Store) {
  ...
  function UserStore(key) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(UserStore).call(this, sessionStorage));
    _this.key = key;
    return _this;
  }
...
var ChatApp = function ChatApp() {
  ...
  this.chatList = new ChatList(LIST_SELECTOR, username); // console.log("Hello ES6!");
...
function () {
  function ChatMessage(_ref) {
    var m = _ref.message,
        _ref$user = _ref.user,
        u = _ref$user === void 0 ? username : _ref$user,
...
exports.default = _default;
},{"./ws-client":"ws-client.js","./dom":"dom.js","./storage":"storage.js"}],"main.js":[function(require,module,exports) {
"use strict";
